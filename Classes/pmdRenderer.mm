...
BOOL pmdRenderer::loadShaders()
{
    ...
    vertShaderPathname = [[NSBundle mainBundle] pathForResource:@"ShaderPlain" ofType:@"vsh"];
    ...
    fragShaderPathname = [[NSBundle mainBundle] pathForResource:@"ShaderPlain" ofType:@"fsh"];
    ...
    glBindAttribLocation(_program, ATTRIB_VERTEX, "myVertex");
    glBindAttribLocation(_program, ATTRIB_NORMAL, "myNormal");
    glBindAttribLocation(_program, ATTRIB_UV, "myUV");
	...
	_uiMatrixLocation = glGetUniformLocation(_program, "myMVPMatrix");
	_uiMatrixWorld = glGetUniformLocation(_program, "myWorldMatrix");
	_uiMatrixWorldView = glGetUniformLocation(_program, "myWorldViewMatrix");
	_uiLight0 = glGetUniformLocation(_program, "vLight0");
	_uiMaterialDiffuse = glGetUniformLocation(_program, "vMaterialDiffuse");
	_uiMaterialAmbient = glGetUniformLocation(_program, "vMaterialAmbient");
	_uiMaterialSpecular = glGetUniformLocation(_program, "vMaterialSpecular");

	// Set the sampler2D uniforms to corresponding texture units
	glUniform1i(glGetUniformLocation(_program, "sTexture"), 0);
